...
const getClientById = asyncHandler(async (req, res) => {
    const client = await User.findById({ _id: req.params.id, role: "client" }).select("-password");
...
const updateClientProfile = asyncHandler(async (req, res) => {
    ...
    const updates = {
        ...
        companyWebsite: req.body.companyWebsite || client.clientProfile.companyWebsite,
